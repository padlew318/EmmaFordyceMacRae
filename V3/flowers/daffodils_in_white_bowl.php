...
<html>
  <head>
    <title>Daffodils in White Bowl | Emma Fordyce MacRae 20th Century American Artist</title>
    <meta charset="UTF-8">
        ...
        <div id="wrapper">
          ...
          <div id="bd">
            ...
            <div id="zWrap">
              <div id="zA">
                <div class="modWrap">
<div class="painting_central">
<a href="<?php echo $base_url; ?>_images/daffodils_in_white_bowl.jpg" alt="Daffodils in White Bowl" rel="lightbox" title="Daffodils in White Bowl"> 
    <img src="<?php echo $base_url; ?>_images/daffodils_in_white_bowl_small.jpg" alt="Daffodils in White Bowl" width="300" ></a>
</div>				
</div>
              </div>
              <div id="zB">
                <div class="modWrap">
					<p> 
		Daffodils in White Bowl<br>Oil Painting<br>Floral still life<br>Emma Fordyce MacRae 1887 - 1974
    </p>
	</div>
              </div>
              <div id="zC">
