<?php
    ...
    $title = 'Amaryllis | Emma Fordyce MacRae 20th Century American Artist';
...
<div class="container">
    ...
    <div class="row">
         <div class="col-lg-4 col-md-3 col-sm-2">
                <a href="<?php echo $base_url; ?>_images/amaryllis.jpg" alt="Amaryllis" data-lightbox="Amaryllis" data-caption="Amaryllis"> 
                <img src="<?php echo $base_url; ?>_images/amaryllis.jpg" alt="Amaryllis" data-lightbox="Amaryllis" data-caption="Amaryllis" class="img-responsive img-thumbnail"></a>
          </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">  
			    <p>Amaryllis<br>Oil Painting<br>Floral still life<br>Emma Fordyce MacRae 1887 - 1974</p>
		    </div>
    </div>
