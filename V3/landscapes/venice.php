<?php
    ...
    $title = 'Venice | Emma Fordyce MacRae 20th Century American Artist';
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-3 col-sm-2">
                <a href="<?php echo $base_url; ?>_images/venice.jpg" alt="Venice" data-lightbox="Venice" data-caption="Venice"> 
                <img src="<?php echo $base_url; ?>_images/venice.jpg" alt="Venice" data-lightbox="Venice" class="img-responsive img-thumbnail"></a>
        </div>
