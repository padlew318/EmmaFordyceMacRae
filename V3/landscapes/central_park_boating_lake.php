...
<html>
  <head>
    <title>Central Park Boating Lake | Emma Fordyce MacRae 20th Century American Artist</title>
    <meta charset="UTF-8">
        ...
        <div id="wrapper">
          ...
          <div id="bd">
            ...
            <div id="zWrap">
              <div id="zA">
                <div class="modWrap">
<div class="painting"><img height="300" src="http://www.emmafordycemacrae.com/images/central_park_boating_lake.jpg" alt="Painting of Beatrice"></div>				
<p></p>
                </div>
              </div>
              <div id="zB">
                <div class="modWrap">
													<p> 
		Central Park Boating Lake<br>Oil Painting<br>New York Landscape<br>Emma Fordyce MacRae 1887 - 1974
    </p>
				</div>
              </div>
              <div id="zC">
