<?php
    ...
    $title = 'Europe | Emma Fordyce MacRae 20th Century American Artist';
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-8">
            <a href="<?php echo $base_url; ?>_images/europe.jpg" alt="Europe" data-lightbox="Europe" data-caption="Europe"> 
            <img src="<?php echo $base_url; ?>_images/europe.jpg" alt="Europe" data-lightbox="Europe" data-caption="Europe" class="img-responsive img-thumbnail"></a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">  
            <hr />
		    <p>Europe<br> Oil Painting<br> Europe Landscape<br> Emma Fordyce MacRae 1887 - 1974</p>
		</div> 
    </div>
