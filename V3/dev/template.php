...
<div class="container">
    ...
    <div class="row">
         <div class="col-lg-4 col-md-3 col-sm-2">
                <a href="<?php echo $base_url; ?>_images/central_park_in_april.jpg" alt="Central Park in April" data-lightbox="Central Park in April" data-caption="Central Park in April"> 
                <img src="<?php echo $base_url; ?>_images/central_park_in_april.jpg" alt="Central Park in April" data-lightbox="Central Park in April" data-caption="Central Park in April" class="img-responsive img-thumbnail"></a>
          </div>
    </div>
