...
<html>
  <head>
    <title>Leonore | Emma Fordyce MacRae 20th Century American Artist</title>
    <meta charset="UTF-8">
...
<a href="<?php echo $base_url; ?>_images/leonore.jpg" alt="Leonore" rel="lightbox" title="Leonore"> 
<img src="<?php echo $base_url; ?>_images/leonore_small.jpg" alt="Leonore" width="300" ></a>
</div>
                </div>
              </div>
              <div id="zB">
                <div class="modWrap">
					<p> 
		Leonore<br>Oil Painting<br>Figurative composition<br>Emma Fordyce MacRae 1887 - 1974
    </p>
	</div>
              </div>
              <div id="zC">
