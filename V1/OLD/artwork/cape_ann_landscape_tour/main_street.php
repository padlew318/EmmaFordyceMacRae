<?php
    ...
    $title = 'Main Street, Gloucester, MA | Emma Fordyce MacRae 20th Century American Artist';
...
<div class="container">
        ...
        <div class="col-lg-12">
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    ...
                    <div class="stepwizard-step">
                        <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/main_street.php" type="button" class="btn btn-primary btn-circle">8</a>
                    </div>
                    <div class="stepwizard-step">
 ...
 <div class="row" style="text-align:center;">
         <div class="col-lg-12">                  
                    ...
                    <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/halfmoon_beach.php" type="button" class="btn btn-info">>></a>
    </div>
    </div>
