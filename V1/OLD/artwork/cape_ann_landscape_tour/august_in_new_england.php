...
<?php require ('../../_includes/bs_nav.php'); ?>
<div class="container">
        ...
        <div class="col-lg-12">
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    ...
                    <div class="stepwizard-step">
                        <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/august_in_new_england.php" type="button" class="btn btn-primary btn-circle">1</a>
                    </div>
                    <div class="stepwizard-step">
 ...
 <div class="row">
         <div class="col-lg-12">
            <p>The oil painting of the landscape <em>August in New England</em> was chosen to be exhibited in Portrait of America Exhibition sponsored by Pepsi Cola in 1945 and is a wonderful example of Emma’s later distinctive painting style and her method of manipulating color to create impressionistic reflections in the water.  In this landscape <em>August in New England</em> you can see Emma’s use of red showing through the different greens around the houses on the opposite shore giving depth to the painting.   The Church on Washington Street remains as do the rocky cliffs but much has changed.</p>
            <p>
 ...
 <div class="row" style="text-align:center;">
         <div class="col-lg-12">                  
                    ...
                    <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/hodgkins_cove.php" type="button" class="btn btn-info">>></a>
    </div>
    </div>
