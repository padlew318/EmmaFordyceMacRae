...
<div class="container">
        ...
        <div class="col-lg-12">
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    ...
                    <div class="stepwizard-step">
                        <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/stage_fort_park.php" type="button" class="btn btn-primary btn-circle">10</a>
                    </div>
                    <div class="stepwizard-step">
 ...
 <div class="row" style="text-align:center;">
         <div class="col-lg-12">                  
                    ...
                    <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/gloucester_garden.php" type="button" class="btn btn-info">>></a>
    </div>
    </div>
...
?>
<script type="text/javascript" src="<?php echo $base_url; ?>_js/stage_fort_park.js"></script>
<?php
