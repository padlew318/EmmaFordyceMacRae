...
<html>
  <head>
    <title>Elizabeth | Emma Fordyce MacRae 20th Century American Artist</title>
    <meta charset="UTF-8">
...
<a href="<?php echo $base_url; ?>_images/elizabeth.jpg" alt="Elizabeth" rel="lightbox" title="Elizabeth"> 
<img src="<?php echo $base_url; ?>_images/elizabeth_small.jpg" alt="Elizabeth" width="300" ></a>
</div>
                </div>
              </div>
              <div id="zB">
                <div class="modWrap">
					<p> 
		Elizabeth<br>Oil Painting<br>Figurative composition<br>Emma Fordyce MacRae 1887 - 1974
    </p>
	</div>
              </div>
              <div id="zC">
