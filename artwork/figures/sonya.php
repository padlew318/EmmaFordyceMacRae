...
<html>
  <head>
    <title>Sonya | Emma Fordyce MacRae 20th Century American Artist</title>
    <meta charset="UTF-8">
...
<a href="<?php echo $base_url; ?>_images/sonya.jpg" alt="Sonya" rel="lightbox" title="Sonya"> 
<img src="<?php echo $base_url; ?>_images/sonya_small.jpg" alt="Sonya" width="300" ></a>
</div>
                </div>
              </div>
              <div id="zB">
                <div class="modWrap">
					<p> 
		Sonya<br>Oil Painting<br>Figurative composition<br>Emma Fordyce MacRae 1887 - 1974
    </p>
	</div>
              </div>
              <div id="zC">
