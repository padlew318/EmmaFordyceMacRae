            ...
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    <div class="stepwizard-step">
                        <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/index.php" type="button" class="btn btn-primary btn-circle">Start</a>
                    </div>
                    <div class="stepwizard-step">
     ...
     <div class="row">
         <div class="col-lg-4">
                  ...
                  <p>Emma Fordyce MacRae is known for her original oil paintings of landscapes, boats, flowers, reflections in the water and docks. She painted in New England, New York and Europe. The Cape Ann Landscapes Tour includes paintings of Cape Ann, MA.</p>
                    ...
                    <ol>
                        <li><a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/august_in_new_england.php">New England</a></li>
                    ...
                    <li><a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/fishermen_at_pigeon_cove.php">Fishermen</a></li>
                    ...
                    <li><a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/main_street.php">Main Street</a></li>
                    <li><a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/halfmoon_beach.php">Half Moon Beach</a></li>
                    ...
                    <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/august_in_new_england.php" type="button" class="btn btn-primary">Start the Cape Ann Landscapes Tour</a>
                   </div>
        <div class="col-lg-8">
