<?php
    $description = 'The picture is an oil painting by Emma Fordyce MacRae of the sweep of Front Beach at Rockport on Cape Ann on a summer’s day.';
    $keywords = 'Emma Fordyce MacRae, oil painting,  beach, cape ann, rockport';
    $title = 'Rockport Beach | Emma Fordyce MacRae 20th Century American Artist';
...
<div class="container">
        ...
        <div class="col-lg-12">
            <div class="stepwizard">
                <div class="stepwizard-row setup-panel">
                    ...
                    <div class="stepwizard-step">
                        <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/rockport_beach.php" type="button" class="btn btn-primary btn-circle">6</a>
                    </div>
                    <div class="stepwizard-step">
    ...
    <div class="row" style="background:#5391AA; margin:5px; padding:5px;" >
         <div class="col-lg-4 col-md-5 col-sm-6">
               <img src="<?php echo $base_url; ?>_images/12_Rockport_Beach_WM.17785147_std.jpg" alt="Rockport Beach" class="img-thumbnail img-responsive">
         ...
         <div class="col-lg-8 col-md-7 col-sm-6" style="padding-top:10px;">
                  ...
                  <p style="color:white;text-align:center;">SatNav : 1 King Street, Rockport, MA</p>
         </div>
 </div>
 <hr>
 <div class="row">
 ...
 <div class="row" style="text-align:center;">
         <div class="col-lg-12">                  
                    ...
                    <a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/white_boat.php" type="button" class="btn btn-info">>></a>
    </div>
    </div>
