...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-2 col-md-6">     
            <h2>Main menu</h2>
            <ul>
                    <li><a href="<?php echo $base_url; ?>artwork/cape_ann_landscape_tour/">Home Page</a></li>
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo $base_url; ?>flowers/oil_paintings_of_flowers.php">Oil paintings of Flowers</a>
                                <ul>
                                    ...
                                    <li><a href="<?php echo $base_url; ?>flowers/orange_lilies.html">orange_lilies</a></li>
                                    <li><a href="<?php echo $base_url; ?>flowers/the_lily.html">the_lily</a></li>
                                    <li><a href="<?php echo $base_url; ?>flowers/tulips_in_hopi_pot.html">tulips_in_hopi_pot</a></li>
                                    <li><a href="<?php echo $base_url; ?>flowers/zinias_with_vermeer.html">zinias_with_vermeer</a></li>
                                </ul>
                            </li>
                            <li><a href="<?php echo $base_url; ?>figures/oil_paintings_of_figures.php">Oil paintings of Figures</a>
                                <ul>
                                    ...
                                    <li><a href="<?php echo $base_url; ?>figures/italian_girl.html">italian_girl.html</a></li>
                                    ...
                                    <li><a href="<?php echo $base_url; ?>figures/stelka.html">stelka.html</a></li>
                                </ul>
                            </li>
                        </ul>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
                ...
                <h2>Test</h2>
                 <ul>
                     <li><a href="<?php echo $base_url; ?>V3/">Work in progress</a></li>
                </ul>
