...
<html>
  <head>
    <title>Amaryllis | Emma Fordyce MacRae 20th Century American Artist</title>
    <meta charset="UTF-8">
...
<a href="<?php echo $base_url; ?>_images/amaryllis.jpg" alt="Amaryllis" rel="lightbox" title="Amaryllis"> 
    <img src="<?php echo $base_url; ?>_images/amaryllis_small.jpg" alt="Amaryllis" width="300" ></a>
</div>
                </div>
              </div>
              <div id="zB">
                <div class="modWrap">
					<p> 
		Amaryllis<br>Oil Painting<br>Floral still life<br>Emma Fordyce MacRae 1887 - 1974
    </p>
	</div>
              </div>
              <div id="zC">
